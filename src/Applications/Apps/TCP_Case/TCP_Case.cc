...
void TCP_Case::initialize(int stage) {
...
void TCP_Case::handleTimer(cMessage *msg) {
    switch (msg->getKind()) {
...
void TCP_Case::socketEstablished(int connId, void *ptr) {
...
void TCP_Case::rescheduleOrDeleteTimer(simtime_t d,
        short int msgKind) {
...
void TCP_Case::socketDataArrived(int connId, void *ptr, cPacket *msg,
        bool urgent) {
...
void TCP_Case::socketClosed(int connId, void *ptr) {
    TCPBasicClientApp::socketClosed(connId, ptr);

    // Nothing to do here...
}

void TCP_Case::socketFailure(int connId, void *ptr, int code) {
