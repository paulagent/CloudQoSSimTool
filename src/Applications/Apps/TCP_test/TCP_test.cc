...
Define_Module (TCP_test);

TCP_test::~TCP_test(){

}

void TCP_test :: initialize(){

            std::ostringstream osStream;

            // Set the moduleIdName
            osStream << "TCP_test." << getId();
...
cGate* TCP_test::getOutGate (cMessage *msg){
...
void TCP_test::processSelfMessage (cMessage *msg){
...
void TCP_test::processRequestMessage (icancloud_Message *sm){
...
void TCP_test::processResponseMessage (icancloud_Message *sm){
...
void TCP_test::receivedEstablishedConnection (cMessage *msg){
