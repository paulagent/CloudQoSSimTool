...
void ApplicationHPC::processResponseMessage (icancloud_Message *sm){
...
void ApplicationHPC::processNetCallResponse (icancloud_App_NET_Message *responseMsg){
...
void ApplicationHPC::processIOCallResponse (icancloud_App_IO_Message *responseMsg){
...
void ApplicationHPC::processCPUCallResponse (icancloud_App_CPU_Message *responseMsg){
...
void ApplicationHPC::processMEMCallResponse (icancloud_App_MEM_Message *responseMsg){
