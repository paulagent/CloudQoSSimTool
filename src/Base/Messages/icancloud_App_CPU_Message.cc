...
icancloud_App_CPU_Message::icancloud_App_CPU_Message(const char *name, int kind): icancloud_App_CPU_Message_Base(name,kind){
...
icancloud_App_CPU_Message::icancloud_App_CPU_Message(const icancloud_App_CPU_Message& other): icancloud_App_CPU_Message_Base(other.getName()){
...
string icancloud_App_CPU_Message::contentsToString (bool printContents){
...
void icancloud_App_CPU_Message::parsimPack(cCommBuffer *b){
