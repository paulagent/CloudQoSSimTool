...
INCLUDE_PATH = \
    ...
    -Isimulations/udp_test \
    -Isimulations/udp_test/results \
    -Isrc \
    -Isrc/Applications \
...
clean:
	...
	$(Q)-rm -f simulations/udp_test/*_m.cc simulations/udp_test/*_m.h
	$(Q)-rm -f simulations/udp_test/results/*_m.cc simulations/udp_test/results/*_m.h
