...
INCLUDE_PATH = \
    ...
    -Isimulations/TCP_NodeVL \
    -Isimulations/TCP_NodeVL/results \
    -Isrc \
    -Isrc/Applications \
...
clean:
	...
	$(Q)-rm -f simulations/TCP_NodeVL/*_m.cc simulations/TCP_NodeVL/*_m.h
	$(Q)-rm -f simulations/TCP_NodeVL/results/*_m.cc simulations/TCP_NodeVL/results/*_m.h
